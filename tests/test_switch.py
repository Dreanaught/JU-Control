...
from custom_components.ju_control import async_setup_entry
from custom_components.ju_control.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch(
        "custom_components.ju_control.JuControlApiClient.async_set_title"
    ) as title_func:
